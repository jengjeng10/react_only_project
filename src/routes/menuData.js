...
export const menuData = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/component_separate', label: '컴포넌트 별 분리하기' },
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/use_effect_01', label: '유저 이펙트 실습 01' },
            { path: '/use_effect_02', label: '유저 이펙트 실습 02' },
            { path: '/use_effect_03', label: '유저 이펙트 실습 03' },
    ...
    },
      {
        ...
        items: [
            { path: '/coffee-bread_01', label: 'IT Cafe 01' },
            { path: '/coffee-bread_02', label: 'IT Cafe 02' },
            { path: '/coffee-bread_03', label: 'IT Cafe 03' },
            { path: '/coffee-bread_04', label: 'IT Cafe 04' },
            { path: '/coffee-bread_05', label: 'IT Cafe 05' },
            

        ]
    },
    //여기에 4장, 5장 ... 내용을 게속 추가하면 됩니다. 
];