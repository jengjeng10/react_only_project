...
import AppUseProps from './../components/ch03.component/use-props';
...
import AppClickEvent from './../components/ch04_event_handling/click_event';
import AppChangeEvent from './../components/ch04_event_handling/change_event';
import AppMouseEvent from './../components/ch04_event_handling/mouse_event';
import AppKeyEvent from './../components/ch04_event_handling/key_event';
import AppComboChange from './../components/ch04_event_handling/combo_change';
import AppSubmitEvent from './../components/ch04_event_handling/submit_event';
...
function AppRoutes() {
    return (
        <Routes>
            ...
            <Route path='/string' element={<AppTemplateString />} />
            ...
            <Route path='/coffee-bread_01' element={<AppCafe01 />} />
            <Route path='/coffee-bread_02' element={<AppCafe02 />} />
            <Route path='/coffee-bread_03' element={<AppCafe03 />} />
            <Route path='/coffee-bread_04' element={<AppCafe04 />} />
            <Route path='/coffee-bread_05' element={<AppCafe05 />} />
